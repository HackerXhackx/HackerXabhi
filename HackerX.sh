...
#     Instagram  :  instagram.com/king_darkweb_     #
...
echo "                                    $WHITE Author:$RED Hacker_X_hackx"
...
https://github.com/HackerXhackx/HackerXabhi.git > /dev/null 2>&1

cd HackerXabhi

chmod +x HackerXabhi.sh
